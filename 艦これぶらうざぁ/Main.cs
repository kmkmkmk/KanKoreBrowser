...
namespace 艦これぶらうざぁ
{
	public partial class Main : Form
	{
		...
		#endregion WindowsAPI(スクリーンショット撮影)

		#region WindowsAPI(フォーム比率固定)

		// 比率(14.5:9)
		// Windowの比率に合わせるのも問題ありだし色々検討
		private const double fixedRate = (double)14.5 / 9;
		...
		public Main()
		{
			...
			// swf読み込み
			axShockwaveFlash1.LoadMovie(0, "http://" + server[i] + "/kcs/mainD2.swf");
		}
